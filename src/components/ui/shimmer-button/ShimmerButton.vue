...
defineProps({
  ...
  shimmerSize: { type: String, required: false, default: '0.05em' },
  borderRadius: { type: String, required: false, default: '100px' },
  shimmerDuration: { type: String, required: false, default: '3s' },
  background: { type: String, required: false, default: 'rgba(0, 0, 0, 1)' },
